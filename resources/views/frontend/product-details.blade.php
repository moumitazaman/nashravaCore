                                ...
                                <div class="product-details-inner clearfix">
                                    ...
                                    <div class="details-thumb-big">
                                        @foreach ($sub_images as $key => $image)
                                            <a href="#">
                                                <img class="imageZoom" src="{{ url('public/upload/product_image/product_sub_images/' . $image->sub_image) }}" alt="Nashrava" />
                                            </a>
                                        @endforeach
                                    </div>
                                    ...
                                    <div class="details-thumb-small">
                                        ...
                                        @foreach ($sub_images as $key => $image)
                                            ...
                                            <div class="single-thumb" data-slick-index="<?php echo $i; ?>">
                                                <img src="{{ url('public/upload/product_image/product_sub_images/' . $image->sub_image) }}"
                                                    alt="Nashrava">
                                            </div>
                                        @endforeach
                                    </div>
