                    ...
                    <section class=" content col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>{{__('back_blade.view_product_add')}}
                                            ...
                                            <div class="card" style="border-top:5px solid #007bff;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group col-md-4" style="display:none" id="show">
                                                        <img id="showImage"
                                                             src="{{url('public/upload/no image found.jpg')}}"
                                                            ...
                                                            <div class="col-md-9">
                                                                <select name="product_name" id="product_id"
                                                                    ...
                                                                    @foreach($purchases as $purchase)
                                                                        <option
                                                                            value="{{$purchase->id}}">{{$purchase->product_name}}</option>
                                                                    @endforeach
                                                                </select>
                                                                <font style="color:#e60000">
