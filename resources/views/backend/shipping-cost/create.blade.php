                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                           <label for="category_image">Shipping Cost</label>
                            <input type="text" name="shipping_cost" id="image" class="form-control form-control-sm" required>
                            <font style="color:#e60000">
