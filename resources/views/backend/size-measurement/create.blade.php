          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>Add Size Measurement
                  <a class="btn btn-success btn-sm float-right" href="{{route('size-measurement.index')}}"><i class="fa fa-list"></i>&nbsp;&nbsp;&nbsp;Measurement List</a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                <form  method="post" action="{{route('size-measurement.store')}}"  id="myForm" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="measurement">Measurement</label>
                            <input type="text" name="measurement" class="form-control" placeholder="Please enter size measurement">
