   ...
   <!-- Brand Logo -->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="background-color:#1c1c1c;">
        ...
        <div class="info">
          <a href="#" class="d-block">  Customer Module</a>
        </div>
      </div>
     @if(Request::is('admin*'))
      <!-- Sidebar Menu -->
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
           <li class="nav-item has-treeview @if (Request::is('admin/customer/index') || Request::is('admin/customer/draft/view') || Request::is('admin/local/customer/view') || Request::is('admin/local/customer/due-list') || Request::is('admin/local/customer/edit/invoice/*'))
           menu-open
          @endif" id="side_customer" >
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('customer.index')}}" class="nav-link {{ Request::is('admin/customer/index') ? 'active' : '' }}">
              ...
              <li class="nav-item ">
               ...
               <li class="nav-item ">
                <a href="{{route('local.customer')}}" class="nav-link {{ Request::is('admin/local/customer/view') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:#faf619;">Local Customer View</p>
                </a>
              </li>
               <li class="nav-item ">
                <a href="{{route('local.customer.due.list')}}" class="nav-link {{ Request::is('admin/local/customer/due-list') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:#faf619;">Local Due Customer List</p>
                </a>
              </li>
            </ul>
          </li>
